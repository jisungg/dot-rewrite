...
const completionVariants = cva(
  "flex items-center gap-2 rounded-full border-[.75px] px-2.5 w-fit h-7 text-xs font-medium mb-2 shadow-[inset_0px_-2.10843px_0px_0px_rgb(244,241,238),_0px_1.20482px_6.3253px_0px_rgb(244,241,238)] transition-all duration-200",
  {
    variants: {
      variant: {
