      ...
      <div className="max-w-3xl mx-auto text-center space-y-5">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-medium tracking-tight text-zinc-900 leading-[1.05]">
            ...
            <span className="text-[#0061ff]">stories</span> from .note.
          </h1>
        </motion.div>
        ...
        >
          What we&apos;re learning while building a note-grounded study
          platform — engineering, education, and the slow craft of trust.
        </motion.p>
      </div>
    </section>
  );
